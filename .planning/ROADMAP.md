...
- [ ] **Phase 1: Compliance + Output Foundations** - Skill packaging and standardized response templates are usable.
...
- [ ] **Phase 4: Modernization + Quality Playbooks** - Modern API catalog, quality guidance, and playbooks complete v1.

## Phase Details

### Phase 1: Compliance + Output Foundations
**Goal**: The skill loads correctly and provides standardized refactor/review response templates.
**Depends on**: Nothing (first phase)
**Requirements**: COMP-01, COMP-02, CORE-05
...
Plans:
- [ ] 01-01: Define skill metadata and citation constraints
...
**Depends on**: Phase 1
**Requirements**: CORE-01, CORE-02, CORE-03, CORE-04, CORE-06
**Success Criteria** (what must be TRUE):
  ...
  5. User can find a single constraints section referenced by both workflows.
**Plans**: 2 plans

Plans:
- [ ] 02-01: Build workflow routing and shared constraints section
- [ ] 02-02: Add refactor/review checklists with risk cues
...
**Depends on**: Phase 2
**Requirements**: SWUI-01, SWUI-02, SWUI-03, SWUI-04, SWUI-05, SWUI-06, CONC-01, CONC-02, MOD-02
**Success Criteria** (what must be TRUE):
...
Plans:
- [ ] 03-01: Draft SwiftUI state, navigation, list, composition, and layout guidance
- [ ] 03-02: Add scroll and lightweight concurrency guidance with decision trees

### Phase 4: Modernization + Quality Playbooks
**Goal**: Users can modernize SwiftUI APIs and apply quality, performance, and refactor playbooks safely.
**Depends on**: Phase 3
**Requirements**: PERF-01, PERF-02, TEST-01, MOD-01, PLAY-01
**Success Criteria** (what must be TRUE):
  1. User can replace deprecated SwiftUI APIs using the modern replacement catalog.
  2. User can avoid common performance pitfalls with baseline SwiftUI guidance.
  3. User can apply best-practice patterns for identity stability and expensive work avoidance.
  4. User can introduce lightweight testing/DI seams to reduce refactor risk.
  5. User can follow goal-based refactor playbooks for common migrations.
**Plans**: 2 plans
