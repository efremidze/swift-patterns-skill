...
depends_on: []
files_modified:
  - swift-expert-skill/references/state.md
  - swift-expert-skill/references/view-composition.md
...
must_haves:
  ...
  key_links:
    ...
    - from: "swift-expert-skill/references/navigation.md"
      ...
      pattern: "modern-swiftui-apis\.md"
    - from: "swift-expert-skill/SKILL.md"
      to: "swift-expert-skill/references/view-composition.md"
      via: "Reference list"
...
- In `navigation.md`:
  ...
  <verify>
Open `swift-expert-skill/references/state.md` and confirm it contains a state ownership decision tree plus composition/layout guidance, then check `swift-expert-skill/references/navigation.md` for NavigationStack-based patterns without coordinator mandates.
  </verify>
