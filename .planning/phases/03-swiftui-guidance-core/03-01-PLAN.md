...
must_haves:
  ...
  key_links:
    ...
    - from: "swift-patterns-skill/SKILL.md"
      to: "swift-patterns-skill/references/modern-swiftui-apis.md"
      via: "Reference list"
      pattern: "modern-swiftui-apis\.md"
    - from: "swift-patterns-skill/references/navigation.md"
      to: "swift-patterns-skill/references/modern-swiftui-apis.md"
      via: "Modern replacements mention"
      pattern: "modern-swiftui-apis\.md"
    - from: "swift-patterns-skill/SKILL.md"
      to: "swift-patterns-skill/references/view-composition.md"
      via: "Reference list"
...
- In `navigation.md`:
  ...
  <verify>
Open `swift-patterns-skill/references/state.md` and confirm it contains a state ownership decision tree, then confirm `swift-patterns-skill/references/view-composition.md` contains view extraction/data flow guidance, then check `swift-patterns-skill/references/navigation.md` for NavigationStack-based patterns without coordinator mandates.
...
- Update `swift-patterns-skill/SKILL.md` to:
