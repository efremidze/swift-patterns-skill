...
depends_on: []
files_modified:
  - swift-expert-skill/references/swiftui-architecture.md
  - swift-expert-skill/references/navigation.md
  - swift-expert-skill/references/lists-collections.md
  - swift-expert-skill/references/modern-swiftui-apis.md
...
must_haves:
  ...
  key_links:
    - from: "swift-expert-skill/SKILL.md"
      to: "swift-expert-skill/references/lists-collections.md"
      via: "Reference list"
      pattern: "lists-collections\.md"
    - from: "swift-expert-skill/SKILL.md"
      to: "swift-expert-skill/references/modern-swiftui-apis.md"
      via: "Reference list"
      pattern: "modern-swiftui-apis\.md"
    - from: "swift-expert-skill/references/navigation.md"
      to: "swift-expert-skill/references/modern-swiftui-apis.md"
...
- In `swiftui-architecture.md`:
  ...
  - Add a concise composition section: extracting subviews, passing immutable data, using bindings for edit flows, and callbacks for events.
...
- In `navigation.md`:
  ...
  <verify>
Open `swift-expert-skill/references/swiftui-architecture.md` and confirm it contains a state ownership decision tree plus composition/layout guidance, then check `swift-expert-skill/references/navigation.md` for NavigationStack-based patterns without coordinator mandates.
  </verify>
...
<verification>
- `references/swiftui-architecture.md` includes an ownership decision tree and layout/composition guidance aligned to constraints.
