...
files_modified:
  ...
  - swift-expert-skill/references/swift-concurrency.md
...
must_haves:
  ...
  artifacts:
    - path: "swift-expert-skill/references/scrolling.md"
      ...
      contains: "Pagination"
    - path: "swift-expert-skill/references/swift-concurrency.md"
  ...
  key_links:
    ...
    - from: "swift-expert-skill/references/scrolling.md"
      to: "swift-expert-skill/references/swift-concurrency.md"
...
- Add a short note linking to `references/swift-concurrency.md` for async pagination patterns.
...
- Update `swift-expert-skill/SKILL.md` to:
  ...
  - Keep concurrency guidance short in SKILL.md and point to `references/swift-concurrency.md` for details.
  </action>
  <verify>
Confirm `swift-concurrency.md` is SwiftUI-focused and that SKILL.md links to `references/scrolling.md`.
  </verify>
...
- `references/swift-concurrency.md` focuses on `.task` and `@MainActor` without deep concurrency patterns.
