...
must_haves:
  ...
  artifacts:
    - path: "swift-agent-skill/references/scrolling.md"
      provides: "ScrollView and pagination guidance"
      contains: "Pagination"
    - path: "swift-agent-skill/references/concurrency.md"
  ...
  key_links:
    ...
    - from: "swift-agent-skill/references/scrolling.md"
      to: "swift-agent-skill/references/concurrency.md"
...
<task type="auto">
  ...
  <files>swift-agent-skill/references/scrolling.md</files>
  <action>
...
- Keep guidance practical and free of tool-specific steps.
  ...
  <verify>Open `swift-agent-skill/references/scrolling.md` and confirm it includes a decision tree and pagination trigger guidance.</verify>
...
- `swift-agent-skill/SKILL.md` links to `references/scrolling.md`.
</verification>
