...
must_haves:
  ...
  artifacts:
    - path: "swift-patterns-skill/references/scrolling.md"
      provides: "ScrollView and pagination guidance"
      contains: "Pagination"
    - path: "swift-patterns-skill/references/concurrency.md"
  ...
  key_links:
    ...
    - from: "swift-patterns-skill/references/scrolling.md"
      to: "swift-patterns-skill/references/concurrency.md"
...
<task type="auto">
  ...
  <files>swift-patterns-skill/references/scrolling.md</files>
  <action>
...
- Keep guidance practical and free of tool-specific steps.
  ...
  <verify>Open `swift-patterns-skill/references/scrolling.md` and confirm it includes a decision tree and pagination trigger guidance.</verify>
...
- `swift-patterns-skill/SKILL.md` links to `references/scrolling.md`.
</verification>
