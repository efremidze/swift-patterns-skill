...
must_haves:
  ...
  artifacts:
    - path: "swift-expert-skill/references/invariants.md"
      provides: "Identity and data flow invariants for refactors"
      contains: "Invariants"
    - path: "swift-expert-skill/references/workflows-refactor.md"
      provides: "Behavior-preserving refactor checklist with risk cues"
      contains: "Refactor Checklist"
    - path: "swift-expert-skill/references/workflows-review.md"
  ...
  key_links:
    - from: "swift-expert-skill/references/workflows-refactor.md"
      to: "swift-expert-skill/references/invariants.md"
      via: "Invariants reference"
      pattern: "invariants\\.md"
    - from: "swift-expert-skill/references/workflows-review.md"
      to: "swift-expert-skill/references/invariants.md"
      via: "Invariants reference"
      pattern: "invariants\\.md"
    - from: "swift-expert-skill/SKILL.md"
      to: "swift-expert-skill/references/workflows-refactor.md"
      via: "Reference list"
      pattern: "workflows-refactor\\.md"
    - from: "swift-expert-skill/SKILL.md"
      to: "swift-expert-skill/references/workflows-review.md"
      via: "Reference list"
...
@swift-expert-skill/references/performance.md
...
<task type="auto">
  ...
  <files>swift-expert-skill/references/invariants.md</files>
  <action>
...
- Keep language factual and non-prescriptive about architecture.
  ...
  <verify>Open `swift-expert-skill/references/invariants.md` and confirm the invariants list includes identity, state ownership, navigation source of truth, and cancellable async work.</verify>
...
- `swift-expert-skill/SKILL.md` references the new workflow docs.
</verification>
