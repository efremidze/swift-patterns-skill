...
must_haves:
  ...
  artifacts:
    - path: "swift-agent-skill/references/invariants.md"
    ...
    - path: "swift-agent-skill/references/workflows-review.md"
  ...
  key_links:
    ...
    - from: "swift-agent-skill/references/workflows-review.md"
      to: "swift-agent-skill/references/invariants.md"
      via: "Invariants reference"
      pattern: "invariants\\.md"
    ...
    - from: "swift-agent-skill/SKILL.md"
      to: "swift-agent-skill/references/workflows-review.md"
      via: "Reference list"
...
<task type="auto">
  ...
  <files>swift-agent-skill/references/invariants.md</files>
  <action>
...
- Keep language factual and non-prescriptive about architecture.
  ...
  <verify>Open `swift-agent-skill/references/invariants.md` and confirm the invariants list includes identity, state ownership, navigation source of truth, and cancellable async work.</verify>
...
- `swift-agent-skill/SKILL.md` references the new workflow docs.
</verification>
