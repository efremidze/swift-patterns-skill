...
must_haves:
  ...
  artifacts:
    - path: "swift-agent-skill/references/decisions.md"
  ...
  key_links:
    - from: "swift-agent-skill/SKILL.md"
      to: "swift-agent-skill/references/decisions.md"
...
<task type="auto">
  ...
  <files>swift-agent-skill/references/decisions.md</files>
  <action>
...
- Keep the guidance concise and avoid tool-specific steps or architecture mandates.
  ...
  <verify>Open `swift-agent-skill/references/decisions.md` and confirm the decision table, intent cue examples, and constraints note are present.</verify>
...
- Add `decisions.md` to the Reference Files list.
  ...
  <verify>Open `swift-agent-skill/SKILL.md` and confirm the "Workflow Routing" section links to `references/decisions.md` and references Constraints.</verify>
...
<verification>
- `swift-agent-skill/references/decisions.md` contains routing gates with intent cues.
- `swift-agent-skill/SKILL.md` links to the decisions reference and keeps Constraints as the sole shared block.
</verification>
