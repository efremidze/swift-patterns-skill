...
**Example:**
```markdown
// Source: swift-patterns-skill/references/code-review-refactoring.md
...
```swift
// Source: swift-patterns-skill/references/state.md
...
```swift
// Source: swift-patterns-skill/references/navigation.md
enum Route: Hashable {
    case settings
...
- swift-patterns-skill/references/state.md - State ownership and data flow guidance
- swift-patterns-skill/references/navigation.md - NavigationStack and routing patterns
- swift-patterns-skill/references/performance.md - Cancellable async work example
- swift-patterns-skill/references/code-review-refactoring.md - Review/refactor workflow cues
