...
depends_on: []
files_modified:
  - swift-patterns-skill/references/refactor-playbooks.md
...
must_haves:
  ...
  artifacts:
    - path: "swift-patterns-skill/references/refactor-playbooks.md"
      provides: "Goal-based refactor playbooks for view extraction, navigation migration, and state hoisting."
      contains: "Playbook"
    - path: "swift-patterns-skill/references/workflows-refactor.md"
  ...
  key_links:
    - from: "swift-patterns-skill/references/workflows-refactor.md"
      to: "swift-patterns-skill/references/refactor-playbooks.md"
    ...
    - from: "swift-patterns-skill/SKILL.md"
      ...
      via: "Reference index"
      pattern: "refactor-playbooks.md"
    - from: "swift-patterns-skill/references/refactor-playbooks.md"
      to: "swift-patterns-skill/references/invariants.md"
...
<task type="auto">
  ...
  <files>swift-patterns-skill/references/refactor-playbooks.md</files>
  <action>
...
- Keep language constraint-aligned: no architecture mandates, no tool-specific steps, and avoid deep concurrency guidance.
  ...
  <verify>Open `swift-patterns-skill/references/refactor-playbooks.md` and confirm three playbooks with Goal/Pre-checks/Steps/Verify/Risk cues plus invariant links.</verify>
...
- Ensure links are relative and consistent with existing reference links.
  ...
  <verify>Open `swift-patterns-skill/references/workflows-refactor.md` and `swift-patterns-skill/SKILL.md` to confirm playbook links are present and correct.</verify>
...
<verification>
- `swift-patterns-skill/references/refactor-playbooks.md` provides three goal-based playbooks aligned to invariants.
