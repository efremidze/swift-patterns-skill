...
must_haves:
  ...
  artifacts:
    - path: "swift-patterns-skill/references/performance.md"
      provides: "Baseline performance checklist, identity stability guidance, and safe optimizations."
      contains: "Performance baseline"
    - path: "swift-patterns-skill/references/testing-di.md"
      provides: "Lightweight DI seams and refactor-safe testing guidance."
      contains: "Refactor safety seams"
  key_links:
    - from: "swift-patterns-skill/references/performance.md"
      to: "swift-patterns-skill/references/lists-collections.md"
      via: "Cross-reference for stable identity"
      pattern: "lists-collections.md"
    - from: "swift-patterns-skill/references/performance.md"
      to: "swift-patterns-skill/references/scrolling.md"
      via: "Cross-reference for lazy containers and pagination"
      pattern: "scrolling.md"
    - from: "swift-patterns-skill/references/testing-di.md"
      to: "swift-patterns-skill/references/workflows-refactor.md"
...
<task type="auto">
  ...
  <files>swift-patterns-skill/references/performance.md</files>
  <action>
...
- Add a short "Risk cues" list for when to split a refactor due to performance risks (state ownership changes, list identity changes, async work relocation).
  ...
  <verify>Open `swift-patterns-skill/references/performance.md` and confirm the baseline checklist, safe optimizations, risk cues, and cross-links are present and no tool instructions remain.</verify>
...
<task type="auto">
  ...
  <files>swift-patterns-skill/references/testing-di.md</files>
  <action>
...
- Link to `workflows-refactor.md` for behavior-preserving refactor steps.
  ...
  <verify>Open `swift-patterns-skill/references/testing-di.md` and confirm the new seams checklist, quick guide, and refactor links are present without tool mandates.</verify>
...
<verification>
- `swift-patterns-skill/references/performance.md` focuses on baseline pitfalls, identity stability, and safe optimizations without tool steps.
- `swift-patterns-skill/references/testing-di.md` provides lightweight DI seams and testability guidance without framework mandates.
</verification>
