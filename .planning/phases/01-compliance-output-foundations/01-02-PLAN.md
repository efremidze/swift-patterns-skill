...
Output: Response template sections added to `swift-expert-skill/SKILL.md`.
</objective>
...
Keep wording concise and avoid architecture mandates or formatting rules.
  ...
  <verify>Open `swift-expert-skill/SKILL.md` and confirm the Refactor Response Template section exists with the required steps and allowlist reference.</verify>
...
Keep wording concise and avoid tool-specific instructions.
  ...
  <verify>Open `swift-expert-skill/SKILL.md` and confirm the Review Response Template section exists with the required steps and allowlist reference.</verify>
...
<verification>
- `swift-expert-skill/SKILL.md` contains both Refactor and Review response templates.
