...
key-files:
  created:
    - swift-patterns-skill/references/sources.md
  modified:
...
## Accomplishments
- Added a single Constraints section with citation allowlist enforcement in `swift-patterns-skill/SKILL.md`.
- Aligned SKILL.md scope guidance with AGENTS.md limits and tightened metadata.
- Created the citation allowlist in `swift-patterns-skill/references/sources.md`.
...
- `swift-patterns-skill/SKILL.md` - Adds constraints entry point and removes disallowed guidance.
- `swift-patterns-skill/references/sources.md` - Defines citation allowlist URLs.
