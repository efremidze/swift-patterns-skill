...
This phase is a documentation alignment task inside the Swift skill. The code review/refactor reference currently violates the skill Constraints and is missing a constraints link. Planning must focus on making `swift-patterns-skill/references/code-review-refactoring.md` comply with the single Constraints section in `swift-patterns-skill/SKILL.md`, while preserving the Quick Decision Guide linkage.
...
**Primary recommendation:** Update `swift-patterns-skill/references/code-review-refactoring.md` to include a mandatory Constraints link and remove all disallowed content to preserve the Quick Decision Guide flow.
...
| --- | --- | --- | --- |
| `swift-patterns-skill/SKILL.md` | repo | Single Constraints section | Authoritative constraints source used by all workflows |
| `swift-patterns-skill/references/code-review-refactoring.md` | repo | Code review/refactor reference | Target file linked from Quick Decision Guide |

### Supporting
| Reference | Version | Purpose | When to Use |
| --- | --- | --- | --- |
| `swift-patterns-skill/references/workflows-review.md` | repo | Constraints-linked workflow structure | Use as pattern for required Constraints link |
| `swift-patterns-skill/references/workflows-refactor.md` | repo | Constraints-linked workflow structure | Use as pattern for required Constraints link |
| `swift-patterns-skill/references/decisions.md` | repo | Routing and shared constraints note | Ensure alignment with shared constraints language |
...
Keep Constraints in `swift-patterns-skill/SKILL.md` and link to them from references.
...
| --- | --- | --- | --- |
| Constraints enforcement in references | Custom constraints blocks in each reference | Link to `swift-patterns-skill/SKILL.md#constraints` | Single authoritative source prevents drift |
...
- `swift-patterns-skill/SKILL.md` - Constraints section and Quick Decision Guide linkage
- `swift-patterns-skill/references/code-review-refactoring.md` - Current reference content
- `swift-patterns-skill/references/workflows-review.md` - Required Constraints link pattern
- `swift-patterns-skill/references/workflows-refactor.md` - Required Constraints link pattern
